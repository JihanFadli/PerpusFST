            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <p>Pengajuan peminjaman pustaka pada hari ini <?php echo tanggal($tanggal); ?> telah berhasil. Selanjutnya anda diwajibkan untuk datang pada hari dan jam kerja (maksimal 1 x 48 jam).</p>
